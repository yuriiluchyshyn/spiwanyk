    ...
    return (
      <div className="home-guest">
        <Seo
          ...
          description="Файні Співанки — давай співати! Колекція українських пісень зі словами та акордами. Створюйте власні співаники, діліться ними та співайте разом."
          path="/"
        />
        <div className="hero">
          <div className="hero-fire">🔥</div>
          <h1>Файні Співанки</h1>
